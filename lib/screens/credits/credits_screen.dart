...
class CreditsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child:
          CreditsScreenBuilder(message: message, parentContext: parentContext),
    );
  }
}
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          BlocProvider.of<CreditsBloc>(blocContext).add(
                              CreditsTranslateEvent( message.text));
                        },
                        child: Column(
                          children: [
                            const Icon(
...
Future showCreditsScreen(BuildContext parentContext, Message message) async {
